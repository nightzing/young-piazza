          ...
          <div class="accessory-result">
            ...
            <div class="filter stopPop" id="filter" v-bind:class="{'filterby-show':filterBy}">
              <dl class="filter-price">
                <dt>Price:</dt>
                <dd><a href="javascript:void(0)" @click="sortChecked='all'" v-bind:class="{'cur':sortChecked == 'all'}">All</a></dd>
                <dd v-for="(price,index) in sortFilter">
                  <a href="javascript:void(0)" @click="setSortFilter(index)" v-bind:class="{'cur':sortChecked==index}">{{price.startPrice}} - {{price.endPrice}}</a>
                </dd>
              </dl>
            </div>
